A simple recipe book app that uses HTML, CSS, and Javascript as the frontend, while using PHP and Java as the backend. Also will eventually use SQLite as the database manager.
...
To run tests on the backend, you can run the Java file Store.java or Get.java using:<br>
